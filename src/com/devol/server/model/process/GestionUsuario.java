...
public class GestionUsuario {
	...
	public static Boolean enviarMsgValidarCuenta(String correo,String clave,String nombres,String apellidos) throws UnknownException{
		...
		String remitente="devolmin@gmail.com ";
		Message msg = new MimeMessage(session);
		Multipart mp = new MimeMultipart();
		MimeBodyPart htmlPart = new MimeBodyPart();		
		msg.setFrom(new InternetAddress(remitente.trim().toString(), "https://devolminguillo.appspot.com"));
	...
	private static String buildMensajeActivarCuenta(String correo,String clave) throws UnknownException{
		...
		msgBody = msgBody+"<div style=\"padding:3mm; height:9mm; \"><a style=\"width:100%; height:100%;\"  href='https://devolminguillo.appspot.com/activeaccountuser.html?encoded="+hex+"'\">Validar Cuenta</a></div>";
		return msgBody;
		} catch (Exception ex) {
			// TODO Auto-generated catch block
			LOG.warning(ex.getMessage());
